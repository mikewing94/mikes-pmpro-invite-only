<?php
/*
Plugin Name: Paid Memberships Pro - Mikes Invite Only Add On
Plugin URI: http://www.paidmembershipspro.com/add-ons/pmpro-invite-only/
Description: Modified PMPro plugin, user profile links for "Approved Users" and Invite code generation
Version: .3.2
Author: Mike Wing
Author URI: https://www.michaelwing.co.uk/
*/
...
function pmproio_plugin_row_meta($links, $file) {
	if(strpos($file, 'mikes-pmpro-invite-only.php') !== false)
	{
		$new_links = array(
